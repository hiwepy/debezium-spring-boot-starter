...
import io.debezium.context.CanalContext;
...
public abstract class AbstractFlatMessageHandler implements MessageHandler<FlatMessage>, ApplicationContextAware {
    ...
    public AbstractFlatMessageHandler(List<DebeziumEntry.EntryType> subscribeTypes,
    ...
    public void handlerRowData(DebeziumModel model, List<Map<String, String>> rowData, CanalEventHolder eventHolder, DebeziumEntry.EventType eventType) throws Exception {
