 ...
 */
@ConfigurationProperties(DebeziumPulsarClientProperties.PREFIX)
@Data
public class DebeziumPulsarClientProperties {
	 ...
	 * 配置信息
	 */
	private List<DebeziumPulsarClientProperties.Instance> instances = new ArrayList<>();
