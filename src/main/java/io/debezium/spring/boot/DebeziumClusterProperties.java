...
@ConfigurationProperties(DebeziumClusterProperties.PREFIX)
@Getter
@Setter
@ToString
public class DebeziumClusterProperties {
     ...
     * 配置信息
     */
    private List<DebeziumClusterProperties.Instance> instances = new ArrayList<>();
